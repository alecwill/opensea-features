...
//Here is where we will call the rarity rank function
//getRarityRank(contractAddress, tokenID)

//Then will call the rank down
...
const AssetInfo = ({
  ...
  const { isSubscriber } = useUser() || { isSubscriber: true }
  ...
  //const RarityRank = getRarityRank(address, tokenId)
    ...
    >
      <Flex
        ...
        bg={useColorModeValue(
          rarity ? rarity.type.color.light : 'gray.50',
          rarity ? rarity.type.color.dark : 'black',
        )}
        onClick={(e) => {
      ...
      >
        ...
        >
          <Flex width="100%" alignItems="center">
            ...
            {rarity !== undefined ? ( //CALL THE RANK RIGHT AFTER RANK: TEXT
              <RarityBadge
